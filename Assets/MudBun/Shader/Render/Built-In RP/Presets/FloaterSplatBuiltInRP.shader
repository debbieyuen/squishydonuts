...
Shader "MudBun/Floater Splat (Built-In RP)"
{
	...
	SubShader
	{
		...
		float3 SimplexNoiseGradient6_g287( float3 Position, float Size )
		{
			#ifdef MUDBUN_VALID
		...
		float3 SimplexNoiseGradient6_g288( float3 Position, float Size )
		{
			#ifdef MUDBUN_VALID
			return snoise_grad(Position / max(1e-6, Size)).xyz;
			#else
		...
		void vertexDataFunc( inout appdata_full_custom v, out Input o )
		{
			...
			float3 Outward2dNormalLs5_g286 = float3( 0,0,0 );
			float3 Outward2dNormalWs5_g286 = float3( 0,0,0 );
			float3 localMudBunSplatPoint5_g286 = MudBunSplatPoint( VertexID5_g286 , PositionLs5_g286 , NormalWs5_g286 , NormalLs5_g286 , TangentWs5_g286 , TangentLs5_g286 , CenterWs5_g286 , CenterLs5_g286 , Color5_g286 , EmissionHash5_g286 , Metallic5_g286 , Smoothness5_g286 , Tex5_g286 , TextureWeight5_g286 , SdfValue5_g286 , Outward2dNormalLs5_g286 , Outward2dNormalWs5_g286 );
			float3 temp_output_91_52 = TangentWs5_g286;
			float3 temp_output_91_60 = CenterWs5_g286;
			float3 Position6_g287 = temp_output_91_60;
			float Size6_g287 = 0.1;
			float3 localSimplexNoiseGradient6_g287 = SimplexNoiseGradient6_g287( Position6_g287 , Size6_g287 );
			float3 Position6_g288 = ( temp_output_91_60 + ( _Time.y * _Frequency ) + ( localSimplexNoiseGradient6_g287 * 1.0 ) );
			float Size6_g288 = 0.5;
			float3 localSimplexNoiseGradient6_g288 = SimplexNoiseGradient6_g288( Position6_g288 , Size6_g288 );
			float3 temp_output_66_0 = ( localSimplexNoiseGradient6_g288 * _OffsetAmount );
			...
			o.vertexToFrag27_g289 = temp_output_91_28;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_7_0_g286 = ( _Color * i.vertexToFrag3_g286 * _IsSplatRenderMaterial );
			float4 temp_output_69_0 = ( tex2D( _MainTex, clampResult36_g286 ) * temp_output_7_0_g286 );
			float localComputeOpaqueTransparency20_g289 = ( 0.0 );
			...
			float2 ScreenPos20_g289 = (( ( computeScreenPos18_g286 / (computeScreenPos18_g286).w ) * _ScreenParams )).xy;
			float3 VertPos20_g289 = i.vertexToFrag27_g289;
			...
			float3 Outward2dNormalWs5_g286 = float3( 0,0,0 );
			float3 localMudBunSplatPoint5_g286 = MudBunSplatPoint( VertexID5_g286 , PositionLs5_g286 , NormalWs5_g286 , NormalLs5_g286 , TangentWs5_g286 , TangentLs5_g286 , CenterWs5_g286 , CenterLs5_g286 , Color5_g286 , EmissionHash5_g286 , Metallic5_g286 , Smoothness5_g286 , Tex5_g286 , TextureWeight5_g286 , SdfValue5_g286 , Outward2dNormalLs5_g286 , Outward2dNormalWs5_g286 );
			float Hash20_g289 = (EmissionHash5_g286).w;
			...
			#endif
			float AlphaIn20_g289 = ( (temp_output_7_0_g286).a * staticSwitch50_g286 );
			float AlphaOut20_g289 = 0;
			float AlphaThreshold20_g289 = 0;
			sampler2D DitherNoiseTexture20_g289 = _DitherTexture;
			int DitherNoiseTextureSize20_g289 = _DitherTextureSize;
			int UseRandomDither20_g289 = (int)_RandomDither;
			float AlphaCutoutThreshold20_g289 = _AlphaCutoutThreshold;
			float DitherBlend20_g289 = _Dithering;
			{
			float alpha = AlphaIn20_g289;
			computeOpaqueTransparency(ScreenPos20_g289, VertPos20_g289, Hash20_g289, DitherNoiseTexture20_g289, DitherNoiseTextureSize20_g289, UseRandomDither20_g289 > 0, AlphaCutoutThreshold20_g289, DitherBlend20_g289,  alpha, AlphaThreshold20_g289);
			AlphaOut20_g289 = alpha;
			}
			clip( ( (temp_output_69_0).a * AlphaOut20_g289 ) - AlphaThreshold20_g289);
...
/*ASEBEGIN
Version=18800
-1569;255;1302;771;2343.453;306.431;2.0545;True;False
