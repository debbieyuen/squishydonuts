...
namespace MudBun
{
  ...
  public abstract class MudRendererBase : MonoBehaviour
  {
    ...
    */
    ...
    private NativeArray<int> IndirectDrawArgsInitData
    {
      get
      {
        ...
        {
          m_indirectDrawArgsInitData = new NativeArray<int>(new int[] { 0, numInstances, 0, 0 }, Allocator.Persistent);
        }
    ...
    */
    ...
    public bool NeedsCompute => UpdateNeedsCompute();
    ...
    private void BindRenderResources()
    {
      ...
      switch (RenderModeCategory)
      {
        ...
        case RenderModeCategoryEnum.RayTracedVoxels:
          ...
          if (RenderModeCategory == RenderModeCategoryEnum.RayMarchedSurface)
          {
